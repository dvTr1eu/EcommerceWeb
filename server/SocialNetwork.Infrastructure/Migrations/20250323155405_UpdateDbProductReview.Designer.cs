...
namespace Ecommerce.Infrastructure.Migrations
{
    ...
    [Migration("20250323155405_UpdateDbProductReview")]
    partial class UpdateDbProductReview
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.ChatMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.ChatMessage", b =>
                {
                    b.HasOne("Ecommerce.Core.Entities.Conversation", "Conversation")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.Conversation", b =>
                {
                    b.HasOne("Ecommerce.Core.Entities.Account", "Admin")
                        .WithMany()
                        .HasForeignKey("AdminId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Ecommerce.Core.Entities.Account", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Ecommerce.Core.Entities.ProductReview", b =>
                {
                    b.HasOne("Ecommerce.Core.Entities.Account", null)
                        .WithMany()
